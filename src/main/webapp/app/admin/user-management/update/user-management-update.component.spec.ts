...
describe('User Management Update Component', () => {
      ...
      TestBed.configureTestingModule({
        ...
        providers: [
          FormBuilder,
          {
            ...
            useValue: {
              data: of({ user: new User(123, 'user', 'first', 'last', 'first@last.com', true, 'en', [Authority.CHEF], 'admin') }),
            },
          },
        ],
      })
  ...
  describe('OnInit', () => {
    it('Should load authorities and language on init', inject(
      ...
      fakeAsync(() => {
        // GIVEN
        jest.spyOn(service, 'authorities').mockReturnValue(of(['CHEF']));
        ...
        expect(comp.authorities).toEqual(['CHEF']);
      })
    ));
  });
