...
class CommentResourceIT {
    ...
    public static Comment createEntity(EntityManager em) {
        Comment comment = new Comment().commentContent(DEFAULT_COMMENT_CONTENT);
        return comment;
    }
    ...
    public static Comment createUpdatedEntity(EntityManager em) {
        Comment comment = new Comment().commentContent(UPDATED_COMMENT_CONTENT);
        return comment;
    }
    ...
    void putNewComment() throws Exception {
        ...
        updatedComment.commentContent(UPDATED_COMMENT_CONTENT);
    ...
    void partialUpdateCommentWithPatch() throws Exception {
        ...
        partialUpdatedComment.commentContent(UPDATED_COMMENT_CONTENT);
